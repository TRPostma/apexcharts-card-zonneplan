...
export const ChartCardExternalConfig = t.iface([], {
  ...
  "interaction": t.opt(t.iface([], {
    "drag_pan": t.opt("boolean"),
    "persist_view": t.opt("boolean"),
    "persist_view_storage": t.opt(t.union(t.lit('memory'), t.lit('localStorage'))),
    "reset_on_doubleclick": t.opt("boolean"),
    "view_id": t.opt("string"),
    "overscroll": t.opt(t.iface([], {
      "mode": t.opt(t.union(t.lit('none'), t.lit('soft'), t.lit('infinite'))),
      "factor": t.opt("number"),
      "clamp_to_data": t.opt("boolean"),
    })),
  })),
  "style": t.opt("any"),
  "card_mod": t.opt("any"),
...
export const ChartCardAllSeriesExternalConfig = t.iface([], {
  ...
  "color_thresholds": t.opt(t.array(t.iface([], {
    "lt": t.opt("number"),
    "lte": t.opt("number"),
    "gt": t.opt("number"),
    "gte": t.opt("number"),
